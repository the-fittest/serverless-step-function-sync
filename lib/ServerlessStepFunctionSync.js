  ...
  constructor(serverless, options) {
      ...
      deploy: {
        commands: {
          stepFunctionSync: {
            ...
            lifecycleEvents: ['getStackResources', 'createDefinitionString', 'callUpdateFunction',],
            options: {
              name: {
    ...
    this.hooks = {
      'before:deploy:stepFunctionSync:getStackResources': () => BbPromise.bind(this)
        .then(this.yamlParse),
      'deploy:stepFunctionSync:getStackResources': () => BbPromise.bind(this)
        .then(this.getStackResources),
